    ...
    <div className='max-w-[1280px] mx-auto'>
        ...
        <div className='relative z-[1]'>
            ...
            <motion.div initial={{scale:0.9, opacity:0}} whileInView={{scale:1, opacity:1}} transition={{type:'tween'}} className='rounded-r-md overflow-hidden flex items-center'>
                <Image className="responsive js-build-in-item build-in-scale-fade build-in-animate origin-bottom-right" width="1288" height="992" loading="lazy" decoding="async" alt="" aria-hidden="true" src="/3.png" />
            </motion.div>
            </HoverCard>
        </div>
        <div className='flex flex-col md:flex-row gap-10 '>
                <HoverCard backgroundColor = '#939aff' direction='flex-col' left='0'>
                    ...
                    <div className='overflow-hidden rounded-s-lg'>
                        <Image className="w-full h-auto js-build-in-item build-in-scale-fade build-in-animate" width="1209" height="890" loading="lazy" decoding="async" alt="" aria-hidden="true" src="https://github.githubassets.com/images/modules/site/home-campaign/illu-dependabot.png" />
                    </div>
                </HoverCard>
                <HoverCard backgroundColor = '#939aff' direction='flex-col' left='-400px'>
                    ...
                    <div className='overflow-hidden rounded-s-lg'>
                    <Image className="w-full h-auto " width="1208" height="764" loading="lazy" decoding="async" alt="" aria-hidden="true" src="https://github.githubassets.com/images/modules/site/home-campaign/illu-code-scanning.png" />
                    </div>
                </HoverCard>
        </div>
    </div>

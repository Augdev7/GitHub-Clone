...
const Hero = (props: Props) => {
  ...
  return (
    <div className='relative max-w-[1280px] lg:pt-32 md:px-10 mx-auto pt-16'>
        <Image className='absolute hero-drone top-28 w-1/4 h-auto right-0 xl:right-0' width="500" height="326" priority src="https://github.githubassets.com/images/modules/site/home-campaign/hero-drone.webp" alt="" />
        <div className='flex'>
            <div className='relative '>
                <Image aria-hidden="true" className='' src="https://github.githubassets.com/images/modules/site/home-campaign/lines-hero.svg" width="437" height="637" priority alt="" />
            ...
            <div className= ' absolute pt-32 mt-28 max-md:px-4 ml-4 md:ml-12'>
                <div className='relative md:top-20 mb-[24px]'>
                    <Link onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} href="" className=' border-[1px] border-neutral-600 copilot rounded-full inline-block'>
                        <div className='flex items-center p-3 px-5'>
                            <Image className=" d-block w-auto flex-grow-0 flex-shrink-0 mr-6 max-md:mr-3 scale-110" width="44" height="44" loading="lazy" decoding="async" alt="" aria-hidden="true" src="https://github.githubassets.com/images/modules/site/eyebrow-banner-icon-copilot-x.svg" />
                ...
                <Image src="https://github.githubassets.com/images/modules/site/home-campaign/logos/stripe.svg" alt="Stripe logo" width='90' height="44" priority className="my-3 scale-90"/>
                <Image src="https://github.githubassets.com/images/modules/site/home-campaign/logos/pinterest.svg" alt="Pinterest logo" width='90' height="44" priority className="my-3 scale-90"/>
                <Image src="https://github.githubassets.com/images/modules/site/home-campaign/logos/kpmg.svg" alt="KPMG logo" width='90' height="44" priority className="my-3 scale-90"/>
                <Image src="https://github.githubassets.com/images/modules/site/home-campaign/logos/mercedes.svg" alt="Mercedes-Benz logo" width='90' height="44" priority className="my-3 w-[200px]"/>
                <Image src="https://github.githubassets.com/images/modules/site/home-campaign/logos/pg.svg" alt="P&amp;G logo" width='90' height="44" priority className="my-3 scale-90"/>
                <Image src="https://github.githubassets.com/images/modules/site/home-campaign/logos/telus.svg" alt="Telus logo" width='90' height="32" priority className="my-3 scale-90"/>
                </div>
                </div>
            </div>
        </div>

...
const SolutionNav = (props: Props) => {
  ...
  return (
    <li onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
        <button aria-label onClick={handleOnclick}  type='button' className={`flex max-lg:font-semibold  items-center p-1 max-lg:justify-between max-lg:w-full ${show ? "lg:text-neutral-300": ""}`}>
            Solutions
        ...
        <div className={`relative lg:absolute -ml-5 bg-white rounded-md lg:py-4 p-6 w-[300px] transition ease-in duration-300 ${show ? "opacity-100 " : "opacity-0 hidden top-[2000px]"}`}>
            <div className='lg:border-b-[1px] mb-4 pb-4 pt-4 w-full'>
                ...
                <ul className='text-sm text-neutral-500 mt-1 w-full'>
                    <li >
                        <Link href="" className='block py-2 hover:text-blue-600'>Enterprise</Link>
                    </li>
                    <li>
            ...
            <div className='lg:border-b-[1px] mb-4 pb-4 pt-2 w-full'>
                ...
                <ul className='text-sm text-neutral-500 mt-1 w-full'>
                    <li >
                        <Link href="" className='block py-2 hover:text-blue-600'>CI/CD & Automation</Link>
                    </li>
                    <li className='py-2'>
            ...
            <div className='mb-4 pb-0 pt-2 w-full'>
                ...
                <ul className='text-sm text-neutral-500 mt-1 w-full'>
                    <li >
                        <Link href="" className='block py-2 hover:text-blue-600'>Customer stories</Link>
                    </li>
                    <li className='py-2'>
